	      	...
	      	sidebarPanel(
	        	...
	        	selectInput(inputId="states",label="State or jurisdiction to compare",
	          	choices=c("United States","Alabama","Alaska","Arizona",
	                 ...
	                 sliderInput(inputId="ifr1.c",label="IFR Feb. 1, 2020 (%):",value=0.85,
	                             min=0.05,max=1.5,step=0.05,round=2,ticks=FALSE),
	                 sliderInput(inputId="ifr2.c",label="IFR May. 2, 2020 (%):",value=0.65,
	                             min=0.05,max=1.5,step=0.05,round=2,ticks=FALSE),
	                 sliderInput(inputId="ifr3.c",label="IFR Aug. 2, 2020 (%):",value=0.55,
	                             min=0.05,max=1.5,step=0.05,round=2,ticks=FALSE),
	                 sliderInput(inputId="ifr4.c",label="IFR Nov. 1, 2020 (%):",value=0.5,
	                             min=0.05,max=1.5,step=0.05,round=2,ticks=FALSE),
	                 sliderInput(inputId="ifr5.c",label="IFR Jan. 31, 2021 (%):",value=0.5,
	                             min=0.05,max=1.5,step=0.05,round=2,ticks=FALSE),
