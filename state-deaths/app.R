  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      p("For more information please refer to the",a("CDC technical notes",
        href="https://www.cdc.gov/nchs/nvss/vsrr/covid19/tech_notes.htm",target="_blank",.noWS="after"),"."),
      p("Data is from the CDC (",a("1",href="https://data.cdc.gov/NCHS/Weekly-Counts-of-Deaths-by-State-and-Select-Causes/3yf8-kanr",
      ...
      p("State population size data is from the",a("U.S. census bureau",
